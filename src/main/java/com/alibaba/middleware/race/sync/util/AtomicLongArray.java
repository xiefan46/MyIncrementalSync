...
import com.alibaba.middleware.race.sync.compress.UnsafeUtil;
...
public class AtomicLongArray {
	...
	public final void lazySet(int i, long newValue) {
		unsafe.putOrderedLong(array, byteOffset(i), newValue);
	}
	...
	public final long getAndSet(int i, long newValue) {
		return unsafe.getAndSetLong(array, byteOffset(i), newValue);
	}
	...
	public final long getAndAdd(int i, long delta) {
		return unsafe.getAndAddLong(array, byteOffset(i), delta);
	}
	 ...
	 * the previous value. The function should be side-effect-free, since it
