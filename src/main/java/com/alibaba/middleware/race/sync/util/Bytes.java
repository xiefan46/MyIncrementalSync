...
public class Bytes {
    ...
    public static int toIntUnsafe(byte[] bytes, int offset) {
        if (LexicographicalComparerHolder.UnsafeComparer.littleEndian) {
            return Integer.reverseBytes(LexicographicalComparerHolder.UnsafeComparer.theUnsafe.getInt(bytes, (long) offset + LexicographicalComparerHolder.UnsafeComparer.BYTE_ARRAY_BASE_OFFSET));
        } else {
            return LexicographicalComparerHolder.UnsafeComparer.theUnsafe.getInt(bytes, (long) offset + LexicographicalComparerHolder.UnsafeComparer.BYTE_ARRAY_BASE_OFFSET);
        }
    }
    ...
    public static short toShortUnsafe(byte[] bytes, int offset) {
        if (LexicographicalComparerHolder.UnsafeComparer.littleEndian) {
            return Short.reverseBytes(LexicographicalComparerHolder.UnsafeComparer.theUnsafe.getShort(bytes, (long) offset + LexicographicalComparerHolder.UnsafeComparer.BYTE_ARRAY_BASE_OFFSET));
        } else {
            return LexicographicalComparerHolder.UnsafeComparer.theUnsafe.getShort(bytes, (long) offset + LexicographicalComparerHolder.UnsafeComparer.BYTE_ARRAY_BASE_OFFSET);
        }
    }
    ...
    public static long toLongUnsafe(byte[] bytes, int offset) {
        if (LexicographicalComparerHolder.UnsafeComparer.littleEndian) {
            return Long.reverseBytes(LexicographicalComparerHolder.UnsafeComparer.theUnsafe.getLong(bytes, (long) offset + LexicographicalComparerHolder.UnsafeComparer.BYTE_ARRAY_BASE_OFFSET));
        } else {
            return LexicographicalComparerHolder.UnsafeComparer.theUnsafe.getLong(bytes, (long) offset + LexicographicalComparerHolder.UnsafeComparer.BYTE_ARRAY_BASE_OFFSET);
        }
    }
    ...
    public static int putIntUnsafe(byte[] bytes, int offset, int val) {
        ...
        LexicographicalComparerHolder.UnsafeComparer.theUnsafe.putInt(bytes, (long) offset + LexicographicalComparerHolder.UnsafeComparer.BYTE_ARRAY_BASE_OFFSET, val);
        return offset + SIZEOF_INT;
    }
    ...
    public static int putShortUnsafe(byte[] bytes, int offset, short val) {
        ...
        LexicographicalComparerHolder.UnsafeComparer.theUnsafe.putShort(bytes, (long) offset + LexicographicalComparerHolder.UnsafeComparer.BYTE_ARRAY_BASE_OFFSET, val);
        return offset + SIZEOF_SHORT;
    }
