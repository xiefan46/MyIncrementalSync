...
public class DataSendService {
    ...
    class Worker implements Runnable {
        private SendMetrics sendMetrics = new SendMetrics();
        private ConcurrentLinkedQueue<SendTask> input;
        ...
        public Worker(ConcurrentLinkedQueue<SendTask> input, Socket socket, CountDownLatch latch) {
            this.input = input;
            this.socket = socket;
            this.latch = latch;
            try {
...
//                    stat.info("exception: {}", e.getMessage());
            ...
            latch.countDown();
            stat.info("send worker exit, {}", sendMetrics.desc());
