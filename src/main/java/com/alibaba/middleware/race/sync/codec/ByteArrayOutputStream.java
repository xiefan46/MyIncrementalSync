...
public class ByteArrayOutputStream extends OutputStream {
	 ...
	 *                 if size is negative.
	 */
	public ByteArrayOutputStream(int size,int off) {
		if (size < 0) {
	 ...
	 * the named {@link java.nio.charset.Charset charset}. The length of the
	 * new <tt>String</tt> is a function of the charset, and hence may not be
