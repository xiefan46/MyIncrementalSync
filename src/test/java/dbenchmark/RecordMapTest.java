...
public class RecordMapTest {
     ...
     * 5000w Record
     * Record 4 columns, per column max size 15 byte
     *  result shows that MVStore is faster than HashMap on this condition,about 4 seconds
     * */
    @Test
    ...
    public void getRecord(){
        ...
        while(i++<=kvNum){
            ...
            Record mapRecord=codec.decode(mapV);
            if(i%mod==0){
                System.out.println("get record from MVStore k:"+(key+i)+",v:"+mapRecord);
            }
        }
        long elapse=System.currentTimeMillis()-t1;
